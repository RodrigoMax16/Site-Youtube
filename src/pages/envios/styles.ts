...
export const VideosContainer = styled.div<ContainerProps>`
  width: 100%;
  max-width: 1600px;
  display: flex;
  flex-wrap: wrap;
  column-gap: 25px;
  row-gap: 20px;
  padding: ${({openMenu}) => openMenu? '70px 20px 0 50px' : '70px 10px 0 30px'};
  box-sizing: border-box;
  margin-left: ${({openMenu}) => openMenu? '220px' : '130px'};
`;
